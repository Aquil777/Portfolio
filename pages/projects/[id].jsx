	...
	{/* Single project social sharing */}
					<div>
						...
						<div className="flex items-center gap-3 mt-5">
							{/* Aqui você adiciona o link do GitHub com base nos dados */}
							<a
								href= {props.project.url} 

									target="_blank"
									rel="noopener noreferrer"
									className=" text-gray-400 hover:text-primary-dark dark:hover:text-primary-light p-2 rounded-lg shadow-sm duration-500"
